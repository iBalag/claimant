...
async def download_doc(message: types.Message):
    ...
    with BytesIO() as claim_doc_file:
        ...
        await message.answer(f"{emojis.double_exclamation_mark} Учтите, что заявление было сгенерированно "
                             ...
                             "Обратите внимание, что в сгенерированном исковом заявлении НУЖНО САМОСТОЯТЕЛЬНО УКАЗАТЬ: "
                             "место и дату рождения истца, серию и номер паспорта истца. Место, куда нужно вставить "
                             "эти данные, в иске выделено красным цветом.")
