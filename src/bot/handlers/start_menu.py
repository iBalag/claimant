...
Как только вы нажмёте кнопку "получить" - данные стираются полностью. Если вы выйдите из сессии, и при этом не нажмете кнопку "получить", данные также сотрутся автоматически через сутки.
    """
